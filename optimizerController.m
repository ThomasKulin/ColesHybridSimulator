...
innitialParams = [0.5, 0.01, 0.5, 0.032, 0.032, 0.5, 0.002, 0.37, 0.4, 0.4, 2.4, 0.05];
...
%perspective.
upperBounds = [1, 0.02, 1, 0.002, 0.002, 3, 0.02, 0.5, 1, 3, 6, 0.05];
...
lowerBounds = [0.1, 0.002, 0.1, 0.002, 0.002, 0.1, 0.002, 0.01, 0.02, 0.01, 0.1, 0.002];
